...
async function loadKits(){
  ...
  for(const k of kits){
    const img = k.image_url ? `<img src="${k.image_url}" style="width:100%;height:140px;object-fit:cover;border-radius:16px;border:1px solid rgba(255,255,255,.08);margin-bottom:10px">` : "";
